...
var GithubLink  =   "https://github.com/MaoShiSanKe";
var PayPalLink  =   "https://github.com/MaoShiSanKe";
$('#paypal-donate>a').href = PayPalLink;
$('#github-box>a').href = GithubLink;
var qrcodes = {
    'btc_donate'	:	'./images/pay.png',	// 二维码路径
    'alipay_donate'	:	'../simple/images/pay_aliyun.png',	// 支付宝二维码
    'alipay_donate_link'   :   'https://qr.alipay.com/fkx16859gkvehipdlhzoa2a',   // 支付宝二维码上的链接，必须换成自己的连接！！！手机点击会自动跳转到支付宝。
    'wechat_donate'	:	'../simple/images/pay_wechat.png'
};
